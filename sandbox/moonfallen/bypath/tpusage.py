...
class Options(dict):
    ...
    def opt_version(self):
        print "Usage version:", usage_version
        sys.exit(0)
    ...
    def _gather_flags(self):
        ...
        flags = []
        accumulateClassList(self.__class__, 'optFlags', flags)
    ...
    def _gather_parameters(self):
        ...
        accumulateClassList(self.__class__, 'optStrings',
                                    parameters)
        if parameters:
            import warnings
    ...
    def _gather_handlers(self):
        ...
        dct = {}
        addMethodNamesToDict(self.__class__, dct, "opt_")
    ...
    def getUsage(self, width=None):
        ...
        if longdesc:
            longdesc = ('\n' +
                        string.join(wordWrap(longdesc, width), '\n').strip()
                        + '\n')
...
def docMakeChunks(optList, width=80):
    ...
    for opt in optList:
        ...
        if doc:
            column2_l = wordWrap(doc, colWidth2)
        else:
            column2_l = ['']
