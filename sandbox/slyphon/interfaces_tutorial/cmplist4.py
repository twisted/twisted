...
class IFile(zope.interface.Interface):
   ...
   closed = zope.interface.Attribute("bool indicating the current state of the file object")
   encoding = zope.interface.Attribute("the encoding this file uses")
   mode = zope.interface.Attribute("the I/O mode for this file")
   name = zope.interface.Attribute("the name of the file (or appropriate alternative)") 
   newlines = zope.interface.Attribute("keeps track of the types of newlines encountered in the file")
   softspace = zope.interface.Attribute("Boolean that indicates whether a space character needs to be"
