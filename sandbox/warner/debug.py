...
import banana, slicer, tokens
from banana import Banana, StorageBanana
...
class LoggingBananaMixin:
    ...
    def handleToken(self, token):
        ...
        return Banana.handleToken(self, token)
...
class TokenBanana(TokenBananaMixin, Banana):
    ...
    def reportReceiveError(self):
        Banana.reportReceiveError(self)
...
class TokenStorageBanana(TokenBananaMixin, StorageBanana):
    ...
    def reportReceiveError(self):
        StorageBanana.reportReceiveError(self)
