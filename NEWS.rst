...
Twisted 20.11.0.dev1 (2020-10-18)
=================================

Features
--------

- Implement the AMP version 2 protocol to allow values greater than 64k. (#2529, #9488)
...
- Python 3.8 and 3.9 are now tested and supported. (#9955)
...
- Support for Python 2.7 has been removed. Twisted now supports only Python versions 3.5/3.6/3.7/3.8/3.9. (#9790)
