...
class FlagFunctionTest(unittest.TestCase):
    ...
    def test_hasArg(self):
        ...
        """
        self.assertEqual(0, usage.flagFunction(self.SomeClass().oneArg))
    ...
    def test_noArg(self):
        ...
        exactly no argument.
        """
        self.assertEqual(1, usage.flagFunction(self.SomeClass().noArg))
    ...
    def test_tooManyArguments(self):
        ...
        """
        try:
            usage.flagFunction(self.SomeClass().manyArgs)
