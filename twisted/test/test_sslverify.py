...
class MutualArgumentExclusionTests(unittest.TestCase):
    """
    Tests for L{twisted.internet._sslverify.mutuallyExclusiveArguments}.  Note
    that this is not a public API, and if it were to become one, it should
    (obviously, I hope) move out of SSL-related code.
    """

    def checkPassed(self, func, *args, **kw):
        """
        Test an invocation of L{sslverify.passed} with the given function,
        arguments, and keyword arguments.
        """
        return sslverify.passed(inspect.getargspec(func), args, kw)


    def test_passed_simplePositional(self):
        """
        L{sslverify.passed} identifies the arguments passed by a simple
        positional test.
        """
        def func(a, b):
            pass
    ...
    def test_passed_tooManyArgs(self):
        """
        L{sslverify.passed} raises a L{TypeError} if too many arguments are
        passed.
        """
        def func(a, b):
            pass
    ...
    def test_passed_doublePassKeyword(self):
        """
        L{sslverify.passed} raises a L{TypeError} if a argument is passed both
    ...
    def test_passed_unspecifiedKeyword(self):
        """
        L{sslverify.passed} raises a L{TypeError} if a keyword argument not
    ...
    def test_passed_star(self):
        """
        L{sslverify.passed} places additional positional arguments into a tuple
    ...
    def test_passed_noDefaultValues(self):
        """
        The results of L{sslverify.passed} only include arguments explicitly
