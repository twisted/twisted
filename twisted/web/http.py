            ...
            if key == b'application/x-www-form-urlencoded':
                ...
                try:
                    ...
                    if e.args[0] == b'content-disposition':
                        ...
                        self.channel.respondToBadRequestAndDisconnect()
                        return
                    raise
            self.content.seek(0, 0)
...
class HTTPChannel(basic.LineReceiver, policies.TimeoutMixin):
    ...
    @type maxHeaders: L{_ChunkedTransferDecoder}
    ...
    def lineReceived(self, line):
        ...
        if (self._receivedHeaderSize > self.totalHeadersSize):
            self.respondToBadRequestAndDisconnect()
            return
    ...
    def respondToBadRequestAndDisconnect(self):
        """
