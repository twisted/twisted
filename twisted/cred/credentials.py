...
class DigestCredentialFactory(object):
    ...
    @type authenticationRealm: C{bytes}
    ...
    def _generateNonce(self):
        ...
        @rtype: C{bytes}
        """
        return binascii.hexlify(secureRandom(12))
    ...
    def _verifyOpaque(self, opaque, nonce, clientip=b''):
        """
