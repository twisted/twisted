...
class GroupSession(Toplevel):
    def __init__(self,name,im,*args,**kw):
        ...
        self.name=name
        self.im=im
        self.output=Text(self,height=12,width=50,wrap=WORD,state=DISABLED,bg="white")
        ...
        self.list=Listbox(self,bg="white")
        ...
        self.input=Text(self,height=3,width=65,wrap=WORD,bg="white")
...
class Conversation(Toplevel):
    def __init__(self,im,contact,*args,**kw):
        ...
        self.output=Text(self,height=20,width=50,wrap=WORD,bg="white")
        self.input=Text(self,height=3,width=50,wrap=WORD,bg="white") 
...
class ContactList(Toplevel):
    def __init__(self,im,*args,**kw):
        ...
        Button(self,text="Add Contact",command=self.addContact).grid(column=0,row=1)
        Button(self,text="Remove Contact",command=self.removeContact).grid(column=1,row=1)
        Button(self,text="Send Message",command=self.sendMessage).grid(column=2,row=1)
        Button(self,text="Join Group",command=self.joinGroup).grid(column=3,row=1)
