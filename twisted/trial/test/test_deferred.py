...
class TestSetUp(unittest.TestCase):
    ...
    def test_success(self):
        """
        Tests whether the loaded test suite was successful and fail
        the test if C{result.testsRun} fails.
        """
    ...
    def test_fail(self):
        """
        Test the result of C{detests.DeferredSetUpFail} and fails if
        it is returning any failures
        """
    ...
    def test_callbackFail(self):
        """
        Test the result of C{detests.DeferredSetUpCallbackFail} and
        fails if it is returning any failures in call back.
        """
    ...
    def test_error(self):
        """
        Test the result of L{detests.DeferredSetUpError} and fails if
        it is resulting any set up errors or failures.
        """
    ...
    def test_skip(self):
        """
        Tests for the result of L{detests.DeferredSetUpSkip} and fails
        if it is resulting in any failures or errors.
        """
...
class TestNeverFire(unittest.TestCase):
    def setUp(self):
        """
        Set up the old timeout as the default timeout duration and
        reset the C{util.DEFAULT_TIMEOUT_DURATION} as 0.1
        """
    ...
    def tearDown(self):
        """
        Set the C{util.DEFAULT_TIMEOUT_DURATION} as the value of old
        timeout.
        """
    ...
    def test_setUp(self):
        """
        Test the result of C{detests.DeferredSetUpNeverFire} and fails
        if any failure or errors are detected.
        """
...
class TestTester(unittest.TestCase):
    ...
    def runTest(self, name):
        """
        This test run the C{reporter.TestResult} C{getTest} with the
        argument passed.
        """
