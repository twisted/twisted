...
class _TLSMixin:
    ...
    def doWrite(self):
        ...
        if self.disconnected:
            ...
            # tried to send a TLS close alert.  The TCP connection is still up
            # and we're waiting for the peer to send us back a TLS close alert.
            # Only then will the connection actually be torn down. -exarkun
    ...
    def _postLoseConnection(self):
        ...
        # down the TLS connection cleanly.  Only after the peer responds with a
        # TLS close alert of their own will we disconnect the underlying TCP
        # connection.
