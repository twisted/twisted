...
class OpenSSLCertificateOptions(object):
    ...
    def __init__(self,
        ...
        @param retrieveCertOnly: If L{True}, sets the certificate options such
            that peer certificates are retrieved. This parameter only has an
            effect when C{verify} and C{caCerts} are not specified--otherwise,
            certificates will be verified according to those parameters. This
