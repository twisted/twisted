...
Requires U{pywin32<http://sourceforge.net/projects/pywin32/>} and
U{pyserial<http://pyserial.sourceforge.net/>} and needs to be used with a
reactor implementing L{IReactorWin32Events}.
"""
