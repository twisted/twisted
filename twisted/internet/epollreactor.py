...
class EPollReactor(posixbase.PosixReactorBase, posixbase._PollLikeMixin):
    ...
    # Attributes for _PollLikeMixin
    _POLL_DISCONNECTED = (epoll.EPOLLHUP | epoll.EPOLLERR)
    _POLL_IN = epoll.EPOLLIN
    _POLL_OUT = epoll.EPOLLOUT
