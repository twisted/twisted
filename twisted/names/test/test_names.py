...
class AdditionalProcessingTests(unittest.TestCase):
    ...
    def _additionalTest(self, method, makeRecord, addresses):
        ...
        @param method: The name of the method to use to make a request.  For
            example, C{"lookupNameservers"}.
        @type method: L{str}
        ...
        authority = NoFileAuthority(
            ...
            records={
                soa_record.mname.name: [makeRecord(target)],
                target: addresses,
                },
            )
    ...
    def _additionalCNAMETest(self, addresses):
        ...
        """
        self._additionalTest(
            "lookupCanonicalName", dns.Record_CNAME, addresses)


    def test_canonicalNameAdditionalA(self):
        """
    ...
    def test_canonicalNameAdditionalAAAA(self):
        ...
        """
        self._additionalCNAMETest([self._AAAA])


    def test_canonicalNameAdditionalBoth(self):
        """
