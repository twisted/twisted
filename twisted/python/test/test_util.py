...
class SlowStringCompareTests(unittest.TestCase):
    """
    Tests for L{util.slowStringCompare}
    """
    def test_equal(self):
        """
        L{util.slowStringCompare} returns C{True} for strings that are equal.
        """
    ...
    def test_notEqual(self):
        """
        L{util.slowStringCompare} returns C{False} for strings that are not
        equal.
        """
        c = util.slowStringCompare
    ...
    def test_unicodeComparison(self):
        """
        If only one argument to L{util.slowStringCompare} is unicode, the other
