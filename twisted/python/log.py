...
class PythonLoggingObserver:
    """
    Output twisted messages to Python logging module.

    WARNING: specific logging configuration (example: network) can lead to
    a blocking system. Nothing is done here to prevent that, so be sure to not
    use this, or assume.
    """

    def __init__(self, system="twisted"):
        """
        @param system: system used for getting logger.
        @type system: C{str}
        """
