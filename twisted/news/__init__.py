...
try:
    ...
    raise ImportError("You need to have the third-party news package installed to use twisted.news. See http://projects.twistedmatrix.com/lowdown.")
...
import warnings
warnings.warn("twisted.news is DEPRECATED. See http://projects.twistedmatrix.com/lowdown.", DeprecationWarning)
