...
class _DHGroup1SHA1(object):
    ...
    prime = compat.long('17976931348623159077083915679378745319786029604875601170644'
...
class _DHGroup14SHA1(object):
    ...
    prime = compat.long('32317006071311007300338913926423828248817941241140239112842'
