...
class SSHKeysHandlingTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        file(self.privateKeyFile, 'w').write(keydata.privateRSA_openssh)
        file(self.publicKeyFile, 'w').write('first line\n' +
    ...
    def test_RSA(self):
        """
        Same as testDSA but for RSA keys.
        """
...
class HelpersTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self._get_bytes = common.entropy.get_bytes
        common.entropy.get_bytes = lambda x: '\x55' * x

    def tearDown(self):
        common.entropy.get_bytes = self._get_bytes
...
class KeyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dsaSignature = ('\x00\x00\x00\x07ssh-dss\x00\x00'
            ...
            '\x87\xa9\xc72h\x95')
        self.oldGetBytes = common.entropy.get_bytes
        common.entropy.get_bytes = lambda x: '\xff' * x
        self.keyFile = self.mktemp()
        file(self.keyFile, 'w').write(keydata.privateRSA_lsh)

    def tearDown(self):
        common.entropy.get_bytes = self.oldGetBytes
        del self.oldGetBytes
