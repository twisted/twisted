...
class DomainWithDefaultDict:
    ...
    def fromkeys(klass, keys, value=None):
        ...
        @type value: C{None} or L{IDomain} provider
    ...
    def __getitem__(self, name):
        ...
        @rtype: L{IDomain} provider or C{None}
    ...
    def get(self, key, default=None):
        ...
        @type default: L{IDomain} provider or C{None}
    ...
    def iteritems(self):
        ...
        @rtype: iterator over 2-L{tuple} of (E{1}) L{bytes},
            (E{2}) L{IDomain} provider or C{None}
    ...
    def values(self):
        ...
        @rtype: L{list} of L{IDomain} provider or C{None}
...
class MailService(service.MultiService):
    ...
    @type aliases: C{None} or L{dict} of
