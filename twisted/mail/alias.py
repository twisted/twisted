...
def loadAliasFile(domains, filename=None, fp=None):
    ...
    @type filename: L{bytes} or C{None}
    ...
    @type fp: file-like object or C{None}
...
class MessageWrapper:
    ...
    @type processName: L{bytes} or C{None}
    ...
    def __init__(self, protocol, process=None, reactor=None):
        ...
        @type process: L{bytes} or C{None}
        @param process: The process name.

        @type reactor: C{None} or L{IReactorTime
    ...
    def _processEnded(self, result):
        ...
        @rtype: C{None} or L{Failure <failure.Failure>}
...
class ProcessAliasProtocol(protocol.ProcessProtocol):
    ...
    @type onEnd: C{None} or L{Deferred <defer.Deferred>}
