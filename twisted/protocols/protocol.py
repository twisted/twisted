...
class Protocol:
    ...
    If you are going to write a new protocol for twisted python, start here.
    The docstrings of this class explain how you can get started.  Any protocol
    ...
    def dataReceived(self, data):
        ...
        'data' will be a string of indeterminate length.  Please keep in mind
        that you will probably need to buffer some data, as partial protocol
        messages may be received!  Use this method to translate to a
        higher-level message.  Usually, some callback will be made upon the
        receipt of each complete protocol message.

        I recommend that unit tests for protocols call through to this method
...
class Transport:
    ...
    I represent (and wrap) the physical connection and synchronicity of the
    framework which is talking to the network.  I make no representations about
    ...
    Consider methods of this class (aside from getPeer) to be 'thrown over the
    wall', to happen at some indeterminate time.
    """
    ...
    def getPeer(self):
        ...
        This indicates the other end of the connection.  TYPE indicates what
        sort of connection this is: "INET", "UNIX", or something else.  "INET"
        tuples have 2 additional elements; hostname and port.

        Treat this method with caution.  It is the unfortunate result of the
        CGI and Jabber standards, but should not be considered reliable for the
        usual host of reasons; port forwarding, proxying, firewalls, IP
        masquerading, etcetera.
        '''
