...
It sends a packet out to all hosts on the local network by sending to a magic broadcast address (``"<broadcast>"``).
...
For a complete example using this feature, please see :download:`udpbroadcast.py </projects/core/examples/udpbroadcast.py>`.
