# -*- coding: utf-8 -*-
#
# twisteddocs documentation build configuration file, created by
...
# uncomment this to enable building of whoosh index
#~ extensions.append('sphinxcontrib.whooshindex')
...
latex_documents = [
  ('index2', 'twisted-docs.tex', u'twisted-docs Documentation',
...
apilinks_base_url = '//twistedmatrix.com/documents/%s/api/' % (version,)
traclinks_base_url = '//twistedmatrix.com/trac'
