...
# Construct a model object which will contain the data for display by the web page
...
# The CQuote controller will look up a View (VQuote) and call render() on it, rendering the DOMTemplate
