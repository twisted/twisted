...
class HAProxyWrappingFactoryV1Tests(unittest.TestCase):
    ...
    def test_validIPv4HeaderResolves_getPeerHost(self):
        ...
        """
        factory = HAProxyWrappingFactory(Factory.forProtocol(StaticProtocol))
        proto = factory.buildProtocol(address.IPv4Address('TCP', b'127.0.0.1', 8080))
        transport = StringTransportWithDisconnection()
        proto.makeConnection(transport)
        ...
        self.assertEqual(proto.wrappedProtocol.transport.getPeer().host, b'1.1.1.1')
        ...
        self.assertEqual(proto.wrappedProtocol.transport.getHost().host, b'2.2.2.2')
    ...
    def test_validIPv6HeaderResolves_getPeerHost(self):
        ...
        self.assertEqual(proto.getPeer().port, 8080)
        self.assertEqual(proto.wrappedProtocol.transport.getPeer().host, b'::1')
        self.assertEqual(proto.wrappedProtocol.transport.getPeer().port, 8080)
        self.assertEqual(proto.getHost().host, b'::2')
        self.assertEqual(proto.getHost().port, 8888)
        self.assertEqual(proto.wrappedProtocol.transport.getHost().host, b'::2')
        self.assertEqual(proto.wrappedProtocol.transport.getHost().port, 8888)
...
class HAProxyWrappingFactoryV2Tests(unittest.TestCase):
    ...
    def test_validIPv4HeaderResolves_getPeerHost(self):
        ...
        self.assertEqual(proto.getPeer().port, 8080)
        self.assertEqual(proto.wrappedProtocol.transport.getPeer().host, b'127.0.0.1')
        self.assertEqual(proto.wrappedProtocol.transport.getPeer().port, 8080)
        self.assertEqual(proto.getHost().host, b'127.0.0.1')
        self.assertEqual(proto.getHost().port, 8888)
        self.assertEqual(proto.wrappedProtocol.transport.getHost().host, b'127.0.0.1')
        self.assertEqual(proto.wrappedProtocol.transport.getHost().port, 8888)
    ...
    def test_validIPv6HeaderResolves_getPeerHost(self):
        ...
        """
        factory = HAProxyWrappingFactory(Factory.forProtocol(StaticProtocol))
        proto = factory.buildProtocol(address.IPv4Address('TCP', b'::1', 8080))
        transport = StringTransportWithDisconnection()
        proto.makeConnection(transport)
        ...
        self.assertEqual(proto.getPeer().port, 8080)
        self.assertEqual(
            proto.wrappedProtocol.transport.getPeer().host, b'0:0:0:0:0:0:0:1'
        )
        self.assertEqual(proto.wrappedProtocol.transport.getPeer().port, 8080)
        self.assertEqual(proto.getHost().host, b'0:0:0:0:0:0:0:1')
        self.assertEqual(proto.getHost().port, 8888)
        self.assertEqual(
            proto.wrappedProtocol.transport.getHost().host, b'0:0:0:0:0:0:0:1'
        )
        self.assertEqual(proto.wrappedProtocol.transport.getHost().port, 8888)
