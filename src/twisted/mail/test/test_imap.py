...
class IMAP4UTF7Tests(unittest.TestCase):
    ...
    def test_decodeWithoutFinalASCIIShift(self):
        ...
        """
        self.assertEqual(b'&AL0'.decode('imap4-utf-7'), u"\N{VULGAR FRACTION ONE HALF}")
...
class IMAP4HelperTests(unittest.TestCase):
    ...
    def test_parseTimeInvalidValues(self):
        ...
        """
        invalidStrings = ["invalid-July-2017", "2-invalid-2017", "2-July-invalid"]
...
class IMAP4ClientExamineTests(SelectionTestsMixin, unittest.SynchronousTestCase):
    """
...
class IMAP4ClientSelectTests(SelectionTestsMixin, unittest.SynchronousTestCase):
    """
...
class IMAP4ClientExpungeTests(PreauthIMAP4ClientMixin, unittest.SynchronousTestCase):
    """
...
class IMAP4ClientSearchTests(PreauthIMAP4ClientMixin, unittest.SynchronousTestCase):
    """
...
class IMAP4ClientFetchTests(PreauthIMAP4ClientMixin, unittest.SynchronousTestCase):
    """
...
class IMAP4ClientStatusTests(PreauthIMAP4ClientMixin, unittest.SynchronousTestCase):
    """
...
class IMAP4ClientCopyTests(PreauthIMAP4ClientMixin, unittest.SynchronousTestCase):
    """
...
class CopyWorkerTests(unittest.TestCase):
    ...
    def testUnfeaturefulMessage(self):
        ...
        def cbCopy(results):
            ...
            seen.sort()
            exp = [
                b"Header-Counter: " + intToBytes(i) + b"\r\n\r\nBody " + intToBytes(i)
                for i in range(1, 11)
            ]
            exp.sort()
