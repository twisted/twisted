 ...
 */
  ...
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_3, __pyx_kp_s_This_function_is_intentionally_b};
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initraiser(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initraiser(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_raiser(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_raiser(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
