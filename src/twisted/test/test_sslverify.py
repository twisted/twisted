...
class OpenSSLOptionsECDHIntegrationTests(OpenSSLOptionsTestsMixin, unittest.TestCase):
    """
...
class ServiceIdentityTests(unittest.SynchronousTestCase):
    ...
    def test_invalidHostname(self):
        ...
        cProto, sProto, cWrapped, sWrapped, pump = self.serviceIdentitySetup(
            u"wrong-host.example.com", u"correct-host.example.com"
        )
        self.assertEqual(cWrapped.data, b'')
    ...
    def test_validHostname(self):
        ...
        """
        cProto, sProto, cWrapped, sWrapped, pump = self.serviceIdentitySetup(
            u"valid.example.com", u"valid.example.com"
        )
    ...
    def test_validHostnameInvalidCertificate(self):
        ...
        """
        cProto, sProto, cWrapped, sWrapped, pump = self.serviceIdentitySetup(
            u"valid.example.com", u"valid.example.com", validCertificate=False
        )
    ...
    def test_hostnameIsIndicated(self):
        ...
        cProto, sProto, cWrapped, sWrapped, pump = self.serviceIdentitySetup(
            u"valid.example.com", u"valid.example.com", setupServerContext
        )
    ...
    def test_fallback(self):
        ...
        conn = Connection()
        self.assertIs(
            sslverify.simpleVerifyHostname(conn, u'something.example.com'), None
        )
        self.assertRaises(
...
class ExpandCipherStringTests(unittest.TestCase):
    ...
    def test_doesNotStumbleOverEmptyList(self):
        ...
        """
        self.assertEqual([], sslverify._expandCipherString(u'', SSL.SSLv23_METHOD, 0))
    ...
    def test_doesNotSwallowOtherSSLErrors(self):
        ...
        self.assertRaises(
            SSL.Error, sslverify._expandCipherString, u'ALL', SSL.SSLv23_METHOD, 0
        )
