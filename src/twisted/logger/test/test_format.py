...
class TimeFormattingTests(unittest.TestCase):
    ...
    def test_formatTimeWithDefaultFormat(self):
        ...
        # UTC
        testForTimeZone(
            "UTC+00", u"2006-06-30T00:00:00+0000", u"2007-01-31T00:00:00+0000"
        )
        ...
        # No DST
        testForTimeZone(
            "CST+06", u"2006-06-30T00:00:00-0600", u"2007-01-31T00:00:00-0600"
        )
...
class ClassicLogFormattingTests(unittest.TestCase):
    ...
    def test_formatNamespace(self):
        ...
        self.assertEqual(
            formatEventAsClassicLogText(event), u"- [my.namespace\x23-] XYZZY\n"
        )
    ...
    def test_formatLevel(self):
        ...
        self.assertEqual(formatEventAsClassicLogText(event), u"- [-\x23warn] XYZZY\n")
    ...
    def test_formatSystem(self):
        ...
        self.assertEqual(
            formatEventAsClassicLogText(event), u"- [S.Y.S.T.E.M.] XYZZY\n"
        )
    ...
    def test_formatSystemUnformattable(self):
        ...
        self.assertEqual(
            formatEventAsClassicLogText(event), u"- [UNFORMATTABLE] XYZZY\n"
        )
    ...
    def test_formatFormat(self):
        ...
        self.assertEqual(formatEventAsClassicLogText(event), u"- [-\x23-] id:123\n")
...
class FormatFieldTests(unittest.TestCase):
    ...
    def test_formatWithCall(self):
        ...
        self.assertEqual(
            formatWithCall(u"Hello, {repr()!r}.", dict(repr=lambda: "repr")),
            "Hello, 'repr'.",
        )
...
class EventAsTextTests(unittest.TestCase):
    ...
    def test_eventWithTraceback(self):
        ...
        event = {"log_format": u"This is a test log message"}
        event["log_failure"] = f
    ...
    def test_eventAsTextSystemOnly(self):
        ...
        t = mktime((2013, 9, 24, 11, 40, 47, 1, 267, 1))
        event = {"log_format": u"ABCD", "log_system": u"fake_system", "log_time": t}
        event["log_failure"] = f
        eventText = eventAsText(
            event, includeTimestamp=False, includeTraceback=False, includeSystem=True
        )
        self.assertEqual(eventText, u"[fake_system] ABCD")
    ...
    def test_eventAsTextTimestampOnly(self):
        ...
        self.assertEqual(eventText, u"2013-09-24T11:40:47+0000 ABCD")
    ...
    def test_eventAsTextSystemMissing(self):
        ...
        t = mktime((2013, 9, 24, 11, 40, 47, 1, 267, 1))
        event = {"log_format": u"ABCD", "log_time": t}
        event["log_failure"] = f
        eventText = eventAsText(
            event, includeTimestamp=False, includeTraceback=False, includeSystem=True
        )
        self.assertEqual(eventText, u"[-\x23-] ABCD")
    ...
    def test_eventAsTextSystemMissingNamespaceAndLevel(self):
        ...
        self.assertEqual(eventText, u"[test\x23info] ABCD")
    ...
    def test_eventAsTextSystemMissingLevelOnly(self):
        ...
        t = mktime((2013, 9, 24, 11, 40, 47, 1, 267, 1))
        event = {"log_format": u"ABCD", "log_time": t, "log_level": LogLevel.info}
        event["log_failure"] = f
        eventText = eventAsText(
            event, includeTimestamp=False, includeTraceback=False, includeSystem=True
        )
        self.assertEqual(eventText, u"[-\x23info] ABCD")
