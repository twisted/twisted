...
class IHostnameResolver(Interface):
    ...
    def resolveHostName(resolutionReceiver, hostName, portNumber: int,
                        addressTypes, transportSemantics: str):
        """
...
class IReactorTime(Interface):
    ...
    def callLater(delay, f: Callable[..., Any], *args, **kw):
        """
        ...
        @param f: the callable object to call later.
...
class IReactorFromThreads(Interface):
    ...
    def callFromThread(f: Callable[..., Any], *args, **kw):
        """
        ...
        If you're writing a multi-threaded application the C{f}
...
class IReactorInThreads(Interface):
    ...
    def callInThread(f: Callable[..., Any], *args, **kwargs):
        """
...
class IReactorCore(Interface):
    ...
    def addSystemEventTrigger(phase: str, eventType: str,
        ...
        @param f: the object to call before shutdown.
    ...
    def callWhenRunning(f: Callable[..., Any], *args, **kw):
        """
