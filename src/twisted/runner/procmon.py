...
class _Process(object):
    ...
    @deprecate.deprecated(incremental.Version('Twisted', 18, 7, 0, release_candidate=2))
    def toTuple(self):
        """
...
class ProcessMonitor(service.Service):
    ...
    @deprecate.deprecatedProperty(incremental.Version('Twisted', 18, 7, 0, release_candidate=2))
    def processes(self):
        """
