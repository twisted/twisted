...
@deprecated(Version("Twisted", 20, 11, 0), replacement="d.items()")
def iteritems(d):
    """
...
@deprecated(Version("Twisted", 20, 11, 0), replacement="d.values()")
def itervalues(d):
    """
...
@deprecated(Version("Twisted", 20, 11, 0), replacement="list(d.items())")
def items(d):
    """
...
@deprecated(Version("Twisted", 20, 11, 0), replacement="b'%d'")
...
@deprecated(Version("Twisted", 20, 11, 0), replacement="os.environb")
def bytesEnviron():
    """
...
deprecatedModuleAttribute(
    Version("Twisted", 20, 11, 0), "Use html.escape directly", __name__, "escape"
)
...
deprecatedModuleAttribute(
    Version("Twisted", 20, 11, 0), "Use sys.intern() directly", __name__, "intern"
)
